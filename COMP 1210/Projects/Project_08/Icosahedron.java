...
// ==================
   ...
   public Icosahedron(String labelIn, String colorIn, double edgeIn) {
      ...
      // Count the number of icosahedrons created 
   ...
   /**
    * Gets the count of icosahedrons created.
    *
    * @param 
    * @return count returns Icos created 
    */
   ...
   /**
    * Checks if new object is an Ico or equal to an
    * existing Ico.
    *
    * @param obj object
    * @return false if not Ico or equal to Ico that exists 
    */
   ...
   /**
    * Method required by checkstyle, for Style!
