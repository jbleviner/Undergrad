...
public class HandoutExamples {
   ...
   public static void main(String[] args) {
      String sourceText = "I am the big orange fox. I have come to eat your children and eat them. Please leave your children on the front porch so I can slaughter them and feast.";
      int k = 2;
