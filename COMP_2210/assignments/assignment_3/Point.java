...
public final class Point implements Comparable<Point> {
  ...
  /** Compare two points with respect to the slope each makes with this point. */
    ...
    * 
    * @param xIn (int) the x value for a point
    * @param yIn (int) the y value for a point
    */
    ...
    * 
    * @return returns string representation of a point
    ...
    * met.
    *
    * @param obj (Object) an Object to compare to this
    * @return true or false, returns a boolean based on if obj is equal to this
    * THIS METHOD IS PROVIDED FOR YOU AND MUST NOT BE CHANGED.
    */
   @Override
    ...
    *
    * @param that (Point) a point
    * @return returns an int representation of a comparison of this and that
    */
   @Override
    ...
    *
    * @param that (Point) a point
    * @return slope (double) returns slope of this and that
    */
   ...
   private class ComparePointsBySlope implements Comparator<Point> {
       ...
       *
       * @param p1 (Point) a point to compare to p2
       * @param p2 (Point) a point to compare to p1
       * @return cmp (int) returns int representation of the comparison 
       */
      @Override   
